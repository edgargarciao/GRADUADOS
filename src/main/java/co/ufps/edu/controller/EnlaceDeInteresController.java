...
public class EnlaceDeInteresController {
	 ...
	 */
	 ...
	 public String registrarEnlaceDeInteres(@ModelAttribute("enlaceDeInteres") EnlaceDeInteres enlaceDeInteres, Model model) {
	 ...
	 /**
	  ...
	  public String editarEnlaceDeInteres(@ModelAttribute("enlaceDeInteres") EnlaceDeInteres enlaceDeInteres, Model model) {
	  ...
	  public String borrarEnlaceDeInteres(@ModelAttribute("enlaceDeInteres") EnlaceDeInteres enlaceDeInteres, Model model) {
